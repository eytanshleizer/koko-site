...
<Callout title="The hardest part" variant="accent">
Most failed AI systems I've seen got the first four agents right and got the Conductor wrong. The Conductor is mostly bookkeeping plus a decision rule. The decision rule is where taste lives.
</Callout>
